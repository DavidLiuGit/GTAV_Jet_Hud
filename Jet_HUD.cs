...
public class Jet_HUD : Script
{
	...
	private const string ScriptAuthor = "iLike2Teabag & Kryo4lex";
	...
	private void OnTick(object sender, EventArgs e)
	{
		...
		if (this.Aircraft != null)
		{
			...
			// detect inputs
			if (Game.IsControlPressed(GTA.Control.VehicleFlyYawLeft) && Game.IsControlPressed(GTA.Control.VehicleFlyYawRight))
			{
				Countermeasures.deployCountermeasures(this.Aircraft, Countermeasures.Type.Chaff);
	...
	private void drawArtificialHorizon()
	{
		...
		//float rotationArray = y / 360f;
		//this._wShape.Rotation = rotationArray;
